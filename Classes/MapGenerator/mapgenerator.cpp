...
//enum{height = 17, weight = 23};
const double screen_height = 780.0, screen_weight = 1200.0;
const double ship_x = 50, ship_y = 50;
const int height = screen_height / ship_y - 1;
const int weight = screen_weight / ship_x - 1;
const double new_screen_height = height * ship_y;
const double new_screen_weight = weight * ship_x;

const double delta_y = new_screen_height / height / 2;
const double delta_x = new_screen_weight / weight / 2;

const double square_y = new_screen_height / height;
const double square_x = new_screen_weight / weight;
vector < vector <int> > A;
...
int bfs(struct point now_point, struct point end_point, vector <vector <int> > vect)
{
...
pair<vector <vector <int> >, pair<vector <struct point>, int> > dfs(struct point start_point, struct point end_point, struct point now_point,
        vector <vector <int> > now_state_map, int depth, vector <struct point> answer)
{
    ...
    return dfs(start_point, end_point, point(possible_points[pos].x, possible_points[pos].y), now_state_map, depth + 1, answer);
}
